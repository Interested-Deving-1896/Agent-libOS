...
class TestCodingAgentImage:
    ...
    def test_coding_agent_prompt_guides_practical_tool_use(self) -> None:
        ...
        required_phrases = ['practical coding agent', 'Scale the size', 'Adaptive operating loop', 'read_directory', 'create_memory_object', 'create_memory_namespace', 'fork_child_process', 'spawn_child_process', 'list_memory_namespace', 'request_permission', 'load_image_from_yaml', 'ask_human', 'parse_pytest_log', 'process_exit', 'Never claim that tests', 'least-privilege permission', 'Do not over-decompose']
