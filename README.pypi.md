...
[documentation home](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/index.md); historical design material is identified
separately below.
...
```bash
git clone --branch v1.6.0 https://github.com/yingqi-z20/Agent-libOS.git
cd Agent-libOS
uv sync --frozen
...
If setup or the demo fails, use [Troubleshooting](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/troubleshooting.md).

Choose the next path by role:

- user/operator: [CLI guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/cli.md), [Python API](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/python_api.md), or
  [Electron GUI](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/gui.md);
- security reviewer: [threat model](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/threat_model.md),
  [Capabilities](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/capabilities.md), and [data flow](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/data_flow.md);
- extension author: [AgentImages](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/agent_images.md), [Skills](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/skills.md),
  [Tools/JIT](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/tools_and_jit.md), or [Runtime Modules](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/modules.md);
- contributor/maintainer: [development](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/development.md),
  [benchmarking](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/benchmark.md), and [releasing](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/releasing.md).
...
configuration, and required evidence. Consult the [support matrix](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/support_matrix.md)
and maintained contract pages before generalizing from one demo or test run.

## Documentation

The [documentation home](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/index.md) routes by audience and task and contains
the complete current-contract inventory. Direct entry points are grouped here.

### Use and operate Agent libOS

- [CLI Guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/cli.md) for workflows and security semantics;
- [machine-generated exhaustive CLI reference](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/cli_reference.md) for the
  checked-in parser, with the same installed version's `--help` as the live
  source;
- [Python API](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/python_api.md) and [Electron GUI](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/gui.md);
- [configuration guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/configuration.md) plus the
  [machine-generated exhaustive field reference](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/configuration_reference.md);
- [troubleshooting](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/troubleshooting.md), [storage/migration](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/storage.md),
  and [support matrix](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/support_matrix.md);
- [Durable Task Runs](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/durable_task_runs.md),
  [Object Memory](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/object_memory.md), and [checkpoints](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/checkpoints.md).

### Understand the runtime and security boundary

- [architecture](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/architecture.md), [runtime model](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/runtime_model.md),
  [glossary and version map](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/glossary.md), and
  [threat model](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/threat_model.md);
- [Capabilities](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/capabilities.md),
  [Task Authority Manifests](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/task_authority_manifest.md), and
  [data flow and trusted Sinks](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/data_flow.md);
- [semantic approval/data identification](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/semantic_shadow.md),
  [Explainable Operations](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/explainable_operations.md), and
  [Runtime events](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/events.md);
- [evidence payload retention](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/evidence_payload_retention.md) and
  [runtime invariants](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/invariants.md).

### Extend and integrate

- [AgentImage authoring](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/agent_images.md) and the specialized
  [`mini-swe-agent` Image](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/mini_swe_agent_image.md);
- [Skills](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/skills.md), [Tools and Deno/TypeScript JIT](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/tools_and_jit.md),
  and [startup Runtime Modules](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/modules.md);
- [Protected Operation SDK](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/protected_operation_sdk.md) and
  [provider substrate](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/providers.md);
- [typed Git](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/git.md), [JSON-RPC](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/jsonrpc.md), and
  [MCP client](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/mcp.md);
- [GUI API schema subset](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/gui_api_schema.json).

### Evaluate, contribute, and release

- [benchmark contract](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/benchmark.md),
  [runtime-safety schema](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/benchmarks/runtime_safety/schema.md),
  [external-effect recovery](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/benchmarks/external_effect_recovery/README.md), and
  [runtime-publication recovery](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/benchmarks/runtime_publication_recovery/README.md);
- [practical workflows](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/benchmarks/practical_agent_workflows/README.md),
  [built-in Tool Skill evaluation](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/benchmarks/builtin_tool_skills/README.md),
  [long-horizon evaluation](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/benchmarks/long_horizon_agent/README.md), and
  [AgentDojo](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/experiments/agentdojo/README.md);
- [development guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/development.md), [release status](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/release_status.md),
  and [maintainer release runbook](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/releasing.md);
- [artifact anonymity](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/artifact_anonymity.md),
  [research thesis](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/paper_thesis.md), [security policy](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/SECURITY.md),
  [contribution guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/CONTRIBUTING.md), [changelog](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/CHANGELOG.md), and
  [agent guidance](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/AGENTS.md).
...
- [historical design archive notice](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/agent_libos_design_doc.md);
- [historical paper roadmap notice](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/plan.md);
- [retired commit-bound prelaunch review](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/prelaunch_hardening_report.md);
- [commit-bound pre-implementation semantic research](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/semantic_permission_and_dataflow_research.md).
...
| Task | Canonical page |
| --- | --- |
| Install, test, or change dependencies | [Development Guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/development.md) |
| Build, validate, publish, or recover artifacts | [Release Runbook](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/releasing.md) |
| Migrate, back up, restore, or diagnose a store | [Storage](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/storage.md) |
| Configure fields, profiles, modules, or providers | [Configuration Guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/configuration.md) |
| Operate the desktop or GUI server | [GUI Guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/gui.md) |
| Run or interpret evaluations | [Benchmark Contract](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/benchmark.md) |
| Find a CLI workflow or every parser option | [CLI Guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/cli.md) / [generated reference](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/cli_reference.md) |
...
digest/state, and only then apply it. See [Storage](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/storage.md) and
[Troubleshooting](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/troubleshooting.md).
...
[Tools and JIT](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/tools_and_jit.md#on-demand-tool-skills) and the offline
...
Use [Configuration](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/configuration.md) for precedence and security semantics,
the [generated field reference](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/configuration_reference.md) for exact fields
and defaults, and [Development](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/development.md#real-llm-smoke) for an
...
Read the [Threat Model](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/threat_model.md) for assets, adversaries, TCB,
guarantees, and non-goals; [Runtime Invariants](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/invariants.md) maps current
claims to tests.

## Contributing, Evaluation, and Releases

Use the [Development Guide](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/development.md) for environment setup, test
...
the [Benchmark Contract](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/benchmark.md) to interpret denominators or failure.

The [Release Status](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/release_status.md) describes conditional scope and
...
authorization and the [Release Runbook](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/docs/releasing.md).

See [CONTRIBUTING.md](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/CONTRIBUTING.md) for pull-request expectations and
[SECURITY.md](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/SECURITY.md) for confidential vulnerability reporting. The project
is licensed under the terms in [LICENSE](https://github.com/yingqi-z20/Agent-libOS/blob/v1.6.0/LICENSE).
