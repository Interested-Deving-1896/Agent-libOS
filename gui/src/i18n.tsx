...
const en = {
    ...
    "image.register.message": "This registers a new AgentImage manifest. It changes image visibility but does not grant resource capabilities.",
...
const zhCN: Record<TranslationKey, string> = {
    ...
    "image.register.message": "这会注册新的 AgentImage manifest。它只改变镜像可见性，不授予资源 capability。",
